  ...
  const [events, setEvents] = useState<LiveEvent[]>(() => [
    {
      ...
      source: '10.0.1.101:51200',
      destination: '10.0.2.99:445',
      proto: 'SMB',
      type: 'alert',
      summary: 'Pass-the-hash SMB connection attempt targeting core database CORE-DB-CLUSTER-01',
      severity: 'critical',
    },
    {
      id: 'evt-2',
      time: new Date(Date.now() - 15000).toLocaleTimeString(),
      source: '10.0.3.44:53102',
      destination: '10.0.0.2:53',
      proto: 'DNS',
      type: 'dns',
      summary: 'TXT query for p0q8w-exfil-node.info (Shannon entropy 5.12)',
      severity: 'high',
    },
    {
      id: 'evt-3',
      time: new Date(Date.now() - 35000).toLocaleTimeString(),
      source: '10.0.2.99:49821',
      destination: '185.220.101.5:443',
      proto: 'TLS',
      type: 'flow',
      summary: 'Periodic C2 beacon packet emitted from SERVER-99 (30.02s interval, 0.4% jitter)',
      severity: 'critical',
    },
    {
      id: 'evt-4',
