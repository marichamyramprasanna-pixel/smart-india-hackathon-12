...
import { ShieldCheck, ShieldAlert, AlertTriangle, ArrowRight, BrainCircuit, Activity } from 'lucide-react'
...
export const HeroStatusPanel: React.FC = () => {
  ...
  const isCritical = currentStage.compromiseProbability >= 80
  const isHigh = currentStage.compromiseProbability >= 50
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="space-y-3 max-w-2xl">
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <span className="text-xs font-mono text-slate-400">
              Live Baseline: {currentStage.timeStr} UTC
            </span>
          </div>
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-300 mt-1 leading-relaxed">
              AI-powered behavioural monitoring and compromise detection analyzing multivariate telemetry deviations across 1,248 monitored endpoints.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg border border-purple-500/30 bg-purple-950/30 text-xs text-purple-200">
            ...
            <div>
              ...
              <span>{currentStage.aiAssessment}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 lg:border-l lg:border-slate-800/80 lg:pl-8">
          ...
          <div className="relative flex items-center justify-center shrink-0">
            <svg className="h-28 w-28 -rotate-90" viewBox="0 0 36 36">
              ...
              <path
                ...
                strokeDasharray={`${currentStage.compromiseProbability}, 100`}
                strokeWidth="3.2"
                strokeLinecap="round"
                stroke="currentColor"
                fill="none"
            ...
            <div className="absolute text-center flex flex-col items-center">
              <span className={`text-2xl font-display font-extrabold font-mono-numbers ${
                ...
                {currentStage.compromiseProbability}%
              </span>
          ...
          <div className="flex flex-col gap-2 w-full sm:w-auto">
            ...
            >
              <span>Investigate DEVICE-042</span>
